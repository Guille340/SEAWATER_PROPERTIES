...
function p = seawaterDepth2Pressure_Kinsler2000(z,lat)

%**************************************************************************
%  p = seawaterDepth2Pressure_Kinsler2000(z,lat)
%
%  DESCRIPTION: calculates depth from hydrostatic (gauge) pressure in 
%  seawater for open oceans using the equation proposed by Kinsler et al
%  (2000).
%
...
%
%  FUNCTION CALLS
%  1) p = seawaterDepth2Pressure_Kinsler2000(z,lat)
%
%  REFERENCES
...
p = 1.00818*(2.42e-6*z + 1 + 5.26e-3*sin(lat*pi/180)^2).*z;
