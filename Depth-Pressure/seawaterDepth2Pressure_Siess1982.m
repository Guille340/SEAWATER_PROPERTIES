...
function p = seawaterDepth2Pressure_Siess1982(z,lat)

%**************************************************************************
%  p = seawaterDepth2Pressure_Siess1982(z,lat)
%
%  DESCRIPTION: calculates depth from hydrostatic (gauge) pressure in 
%  seawater for common oceans using the equation proposed by Siess (1982),
%  as quoted in Leroy & Parthiot (1998).
%
...
%
%  FUNCTION CALLS
%  1) p = seawaterDepth2Pressure_Siess1982(z,lat)
%
%  REFERENCES
...
p = 1.00818*((-1.3e-11*z + 2.453e-6).*z + 1 - 2.64e-3*cos(lat*pi/90)).*z;
